  ...
  useGSAP(
    () => {
      ...
      tl.from(
        ...
        "<0.5",
      ); // Começa 0.5s ANTES do fim da animação anterior (VideoNaMoldura), para um overlap legal
    },
    { scope: containerEventoRef },
  ...
  return (
    ...
    <div ref={containerEventoRef} className={styles.containerEvento}>
      <div className={styles.containerLimitado}>
        <div ref={videoMolduraRef}>
          {" "}
          {/* Adicione a ref para a div do VideoNaMoldura */}
          <VideoNaMoldura videoPath="VideoCosplay.mp4" />
        </div>

        <div ref={textoContainerRef} className={styles.containerTexto}>
          {" "}
      ...
      <h1 className={styles.tituloEvento}>
        {" "}
        <span> Cosplayers </span> Edição 2024{" "}
      </h1>
